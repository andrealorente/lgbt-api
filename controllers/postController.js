...
var postController = {
  ...
  allPosts: function(req, res) {
      var query = 'query { allPosts(after: \"'+ req.query.after +'\") { data { id, title, content, image, author_id, author_data { username, name },tags, created_time, likes },error{code,message}} }';
