...
module.exports.oneEvent = function(req,res) {
...
module.exports.assistantsEvent = function(req,res){};
//Ver interesados en un evento
module.exports.interestedEvent = function(req,res){};
//Asistir a un evento
module.exports.assistEvent = function(req,res){
...
module.exports.interestEvent = function(req,res){
...
//Comentar un evento
module.exports.commentEvent = function(req,res){};
